...
exports.findAllByDeviceId = (req, res) => {
    Summary
        ...
        .catch(err => {
            ...
            return res.status(500).send({
                message: "Error retrieving summaries for device id: " + req.params.device_id
            });
        });
};
...
exports.findLastByDeviceId = (req, res) => {
    Summary
        ...
        .then(summary => {
            if (!summary) {
                return res.status(404).send({
                    message: "No last summary found for device id: " + req.params.device_id
                });
            }
            res.send(summary);
        })
        .catch(err => {
            ...
            return res.status(500).send({
                message: "Error retrieving last summary for device id: " + req.params.device_id
            });
        });
};